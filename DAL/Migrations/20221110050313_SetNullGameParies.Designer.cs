...
namespace BoardGameManager1.Migrations
{
    ...
    [Migration("20221110050313_SetNullGameParies")]
    partial class SetNullGameParies
    {
            ...
            modelBuilder.Entity("BoardGameManager1.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "95e324c1-7d71-4ae4-a6cc-85cd41410f5a",
                            ConcurrencyStamp = "dee497b9-ac28-4781-8421-8c027818cdfd",
                            Name = "Admin",
                            NormalizedName = "Admin"
                        },
                        new
                        {
                            Id = "f35b8a9d-35d0-498d-9232-bbfca4ade4ae",
                            ConcurrencyStamp = "50aa6290-2486-4e69-be94-472855999ae2",
                            Name = "User",
                            NormalizedName = "User"
                        });
                });
            ...
            modelBuilder.Entity("BoardGameManager1.Entities.UserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = "a5c33334-2562-4d1d-abc4-61693c1db986",
                            RoleId = "95e324c1-7d71-4ae4-a6cc-85cd41410f5a"
                        },
                        new
                        {
                            UserId = "0de7fa91-ef11-48f3-84e3-cdb5d4ca6f94",
                            RoleId = "f35b8a9d-35d0-498d-9232-bbfca4ade4ae"
                        });
                });
            ...
            modelBuilder.Entity("DAL.Entities.GameParty", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Date = new DateTime(2022, 11, 10, 11, 3, 13, 218, DateTimeKind.Local).AddTicks(7025),
                            PartyCreatorId = "a5c33334-2562-4d1d-abc4-61693c1db986",
                            UserGamePlaceId = 1
                        });
                });
            ...
            modelBuilder.Entity("DAL.Entities.Player", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            AccountId = "a5c33334-2562-4d1d-abc4-61693c1db986",
                            Name = "admin@gmail.com"
                        },
                        new
                        {
                            Id = 2,
                            AccountId = "0de7fa91-ef11-48f3-84e3-cdb5d4ca6f94",
                            Name = "user@gmail.com"
                        });
                });
            ...
            modelBuilder.Entity("DAL.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "a5c33334-2562-4d1d-abc4-61693c1db986",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "27d55896-1ebf-4260-9c4a-b3608c48c09b",
                            ...
                            SecurityStamp = "4b58350c-599c-4bdc-9aff-03b7f647181a",
                            TwoFactorEnabled = false,
                            UserName = "admin@gmail.com"
                        },
                        new
                        {
                            Id = "0de7fa91-ef11-48f3-84e3-cdb5d4ca6f94",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "35667957-9f78-4f26-a9d9-908ea0c26a95",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEGPrM0+a2DPLt2IDXeNXCxwz6N4b+aTzO0qbm2ijrTLm0wZMouCaC+8Oan/u3yF+ZQ==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "cb36233c-d96a-43f0-b427-ca76412dcdf4",
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("DAL.UserFriend", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            InRequestUserId = "a5c33334-2562-4d1d-abc4-61693c1db986",
                            OutRequestUserId = "0de7fa91-ef11-48f3-84e3-cdb5d4ca6f94",
                            Status = 1
                        });
                });
