...
namespace BoardGameManager1.Migrations
{
    ...
    [Migration("20221110042152_CreateUniqueGamePlaceIndex")]
    partial class CreateUniqueGamePlaceIndex
    {
            ...
            modelBuilder.Entity("BoardGameManager1.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "517715e4-2683-4b45-9f3a-374efcbbe5ae",
                            ConcurrencyStamp = "c2e8fb50-1431-42f8-9078-1693511fb232",
                            Name = "Admin",
                            NormalizedName = "Admin"
                        },
                        new
                        {
                            Id = "1c31789d-9d18-4c65-8653-eea7c93e0096",
                            ConcurrencyStamp = "b2da1a1d-21cf-4d96-b1fe-a2287783f0d4",
                            Name = "User",
                            NormalizedName = "User"
                        });
                });
            ...
            modelBuilder.Entity("BoardGameManager1.Entities.UserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = "4b772e40-d931-4c96-a3fb-68cb9edb6362",
                            RoleId = "517715e4-2683-4b45-9f3a-374efcbbe5ae"
                        },
                        new
                        {
                            UserId = "495c75e1-9a89-4817-8524-9329fad30e57",
                            RoleId = "1c31789d-9d18-4c65-8653-eea7c93e0096"
                        });
                });
            ...
            modelBuilder.Entity("DAL.Entities.GameParty", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Date = new DateTime(2022, 11, 10, 10, 21, 51, 890, DateTimeKind.Local).AddTicks(2780),
                            PartyCreatorId = "4b772e40-d931-4c96-a3fb-68cb9edb6362",
                            UserGamePlaceId = 1
                        });
                });
            ...
            modelBuilder.Entity("DAL.Entities.Player", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            AccountId = "4b772e40-d931-4c96-a3fb-68cb9edb6362",
                            Name = "admin@gmail.com"
                        },
                        new
                        {
                            Id = 2,
                            AccountId = "495c75e1-9a89-4817-8524-9329fad30e57",
                            Name = "user@gmail.com"
                        });
                });
            ...
            modelBuilder.Entity("DAL.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "4b772e40-d931-4c96-a3fb-68cb9edb6362",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "cf8086ca-99a2-41c8-b3c9-0225477f88f0",
                            ...
                            SecurityStamp = "11195537-da47-49e3-8b35-252bd89bfedf",
                            TwoFactorEnabled = false,
                            UserName = "admin@gmail.com"
                        },
                        new
                        {
                            Id = "495c75e1-9a89-4817-8524-9329fad30e57",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "80cb0b28-0ad8-4d22-87f2-92c2d5ca2a5b",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEGPrM0+a2DPLt2IDXeNXCxwz6N4b+aTzO0qbm2ijrTLm0wZMouCaC+8Oan/u3yF+ZQ==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "2e04240d-684b-4f26-b1cd-c87595ac1629",
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("DAL.UserFriend", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            InRequestUserId = "4b772e40-d931-4c96-a3fb-68cb9edb6362",
                            OutRequestUserId = "495c75e1-9a89-4817-8524-9329fad30e57",
                            Status = 1
                        });
                });
