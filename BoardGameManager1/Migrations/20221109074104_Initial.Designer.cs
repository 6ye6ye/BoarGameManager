...
namespace BoardGameManager1.Migrations
{
    ...
    [Migration("20221109074104_Initial")]
            ...
            modelBuilder.Entity("BoardGameManager1.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "91ba74e2-db63-433d-b7e2-f77ae138b682",
                            ConcurrencyStamp = "8e433615-2d4a-4bfe-a046-d086a1cd0ecc",
                            Name = "Admin",
                            NormalizedName = "Admin"
                        },
                        new
                        {
                            Id = "0cc42552-2bd8-4fa2-8ffe-9838d6740913",
                            ConcurrencyStamp = "248988d1-c9ec-4c4d-996d-3b488e25688f",
                            Name = "User",
                            NormalizedName = "User"
                        });
                });
            ...
            modelBuilder.Entity("BoardGameManager1.Entities.UserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = "0cbc4253-bbac-4cdd-9706-bd1e405b7898",
                            RoleId = "91ba74e2-db63-433d-b7e2-f77ae138b682"
                        },
                        new
                        {
                            UserId = "aea5a8cc-131d-4314-933e-7c69109aae43",
                            RoleId = "0cc42552-2bd8-4fa2-8ffe-9838d6740913"
                        });
                });
            ...
            modelBuilder.Entity("DAL.Entities.GameParty", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Date = new DateTime(2022, 11, 9, 13, 41, 4, 14, DateTimeKind.Local).AddTicks(460),
                            PartyCreatorId = "0cbc4253-bbac-4cdd-9706-bd1e405b7898",
                            UserGamePlaceId = 1
                        });
                });
            ...
            modelBuilder.Entity("DAL.Entities.Player", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            AccountId = "0cbc4253-bbac-4cdd-9706-bd1e405b7898",
                            Name = "admin@gmail.com"
                        },
                        new
                        {
                            Id = 2,
                            AccountId = "aea5a8cc-131d-4314-933e-7c69109aae43",
                            Name = "user@gmail.com"
                        });
                });
            ...
            modelBuilder.Entity("DAL.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "0cbc4253-bbac-4cdd-9706-bd1e405b7898",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "953fe705-8b27-4d43-84fb-7ed6384d5fff",
                            ...
                            SecurityStamp = "e244af22-28e7-4a72-825c-a77d0b82e5fe",
                            TwoFactorEnabled = false,
                            UserName = "admin@gmail.com"
                        },
                        new
                        {
                            Id = "aea5a8cc-131d-4314-933e-7c69109aae43",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "3dca05b2-8462-4869-88d8-5e9e6e73c6ad",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEGPrM0+a2DPLt2IDXeNXCxwz6N4b+aTzO0qbm2ijrTLm0wZMouCaC+8Oan/u3yF+ZQ==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "0293f41b-4bbf-4471-a5ff-c555a0698538",
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("DAL.UserFriend", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            InRequestUserId = "0cbc4253-bbac-4cdd-9706-bd1e405b7898",
                            OutRequestUserId = "aea5a8cc-131d-4314-933e-7c69109aae43",
                            Status = 1
                        });
                });
